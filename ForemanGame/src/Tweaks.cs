...
public static class Tweaks
{
    ...
    {
        string dev = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "Content"));
        return Directory.Exists(dev) ? dev : Path.Combine(AppContext.BaseDirectory, "Content");
    }
